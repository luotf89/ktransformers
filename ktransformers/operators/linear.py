...
from ktransformers.operators.quant_w4a16_for_gcu import rearrange_float16_weight
...
class KLinearMarlin(KLinearBase):
    ...
    def load(self, w: dict | nn.Parameter | tuple | None = None, device: str|None = None):
        ...
        # Pack Marlin linear
        qweight, qzeros, scales = rearrange_float16_weight(weight.T.to(torch.bfloat16), self.group_size)
        self.weight = qweight
        self.qzeors = qzeros
        self.scale = scales
        self.g_idx = None
